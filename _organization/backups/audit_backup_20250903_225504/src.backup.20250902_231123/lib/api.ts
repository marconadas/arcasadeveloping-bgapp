...
const PYGEOAPI_URL = getExternalServiceUrl('pygeoapi');
const MINIO_API_URL = getExternalServiceUrl('minioConsole');
const FLOWER_API_URL = getExternalServiceUrl('flowerMonitor');
const KEYCLOAK_URL = ENV.isDevelopment ? 'http://localhost:8083' : 'https://bgapp-auth.pages.dev';
