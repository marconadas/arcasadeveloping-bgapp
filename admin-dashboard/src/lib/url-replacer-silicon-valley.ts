...
export class URLReplacerSiliconValley {
  private static readonly LOCALHOST_PATTERNS = [
    { pattern: /http:\/\/e1a322f9.bgapp-arcasadeveloping.pages.dev/g, replacement: () => 'https://bgapp-scientific.pages.dev' },
    ...
    { pattern: /e1a322f9.bgapp-arcasadeveloping.pages.dev/g, replacement: () => 'bgapp-scientific.pages.dev' },
