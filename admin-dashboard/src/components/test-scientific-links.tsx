  ...
  const testLinks = [
    {
      ...
      fullUrl: 'https://bgapp-scientific.pages.dev/dashboard_cientifico.html'
    },
    {
      name: 'Tempo Real Angola',
      path: '/realtime_angola.html',
      fullUrl: 'https://bgapp-scientific.pages.dev/realtime_angola.html'
    },
    {
      name: 'QGIS Dashboard',
      path: '/qgis_dashboard.html',
      fullUrl: 'https://bgapp-scientific.pages.dev/qgis_dashboard.html'
    },
    {
      name: 'Colaboração',
      path: '/collaboration.html',
      fullUrl: 'https://bgapp-scientific.pages.dev/collaboration.html'
    }
  ];
