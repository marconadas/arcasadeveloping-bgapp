...
const getEnvironment = (): EnvironmentConfig => {
  ...
  if (isDevelopment) {
    ...
    return {
      ...
      scientificInterfacesUrl: 'http://localhost:8085',
      externalServices: {
    ...
    return {
      ...
      scientificInterfacesUrl: 'https://e1a322f9.bgapp-arcasadeveloping.pages.dev',
      externalServices: {
        stacBrowser: 'https://bgapp-stac.pages.dev', // TODO: Deploy STAC Browser
        flowerMonitor: 'https://bgapp-monitor.pages.dev', // TODO: Deploy Flower
        minioConsole: 'https://bgapp-storage.pages.dev', // TODO: Deploy MinIO UI
        pygeoapi: 'https://bgapp-pygeoapi.pages.dev' // TODO: Deploy PyGeoAPI
      }
    };
  }
};
