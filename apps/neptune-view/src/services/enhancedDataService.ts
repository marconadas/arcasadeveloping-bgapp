...
// For external APIs, we proxy through Next.js API routes or a worker base
const WORKER_API_BASE = process.env.NEXT_PUBLIC_BGAPP_WORKER_BASE || 'https://bgapp-api-worker.majearcasa.workers.dev';
const OPEN_METEO_PROXY_BASE = process.env.NEXT_PUBLIC_OPEN_METEO_PROXY_BASE || 'https://open-meteo-proxy.majearcasa.workers.dev';
const API_BASE =
...
export async function fetchSSTData(
  ...
  try {
    ...
    const response = await fetch(buildApiUrl(`/api/environmental/sst?${params}`), {
      method: 'GET',
      headers: {
...
export async function fetchOceanColorData(
  ...
  try {
    ...
    const response = await fetch(buildApiUrl(`/api/environmental/ocean-color?${params}`), {
      method: 'GET',
      headers: {
        'Accept': 'application/json',
      },
...
export async function fetchSalinityData(
  ...
  try {
    ...
    const response = await fetch(buildApiUrl(`/api/environmental/salinity?${params}`), {
      method: 'GET',
      headers: {
        'Accept': 'application/json',
      },
...
export async function fetchVesselLightsData(
  ...
  try {
    ...
    const response = await fetch(buildApiUrl(`/api/nasa/vessel-lights?${params}`), {
      method: 'GET',
      headers: {
        'Accept': 'application/json',
      },
...
export async function fetchMLPredictions(
  ...
  try {
    ...
    const response = await fetch(buildApiUrl(`/api/realtime/ml-predictions?${params}`), {
      method: 'GET',
      headers: {
        'Accept': 'application/json',
      },
...
export async function fetchVesselPresence(
  ...
  try {
    ...
    const response = await fetch(buildApiUrl(`/api/vessels/presence?${params}`), {
      method: 'GET',
      headers: {
        'Accept': 'application/json',
      },
