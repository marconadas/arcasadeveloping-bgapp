    ...
    try {
      ...
      try {
        [overviewResponse, healthResponse, oceanResponse, fisheriesResponse, copernicusResponse] = await Promise.all([
          bgappApi.getDashboardOverview().catch(() => null),
          bgappApi.getSystemHealth().catch(() => null),
          bgappApi.getOceanographicData().catch(() => null),
          bgappApi.getFisheriesStats().catch(() => null),
          bgappApi.getCopernicusRealTimeData().catch(() => null)
        ]);
